...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('commerce_documents', function (Blueprint $table) {
            ...
            $table->foreignId('replacement_of_id')->nullable()->constrained('commerce_documents')->nullOnDelete();
            $table->foreignId('version_of_id')->nullable()->constrained('commerce_documents')->nullOnDelete();
