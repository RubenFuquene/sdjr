 ...
 *     @OA\Property(property="comment_type", type="string", enum={"PR", "SU", "IN", "VA", "RJ"}, example="IN", description="Tipo de comentario: Producto, Soporte, Información, Validación, Rechazo"),
